...
let data = localStorage.getItem("journalEntry");
...
function addToDo(toDo, id, done, trash){
    ...
    const item = `<li class="item">
                    ...
                    <p contentEditable="true" class="text ${LINE}">${toDo} <span id= "date"> </span></p>
...
document.addEventListener("keyup",function(even){
    if(event.keyCode == 13){
        ...
        if(toDo){
            ...
            localStorage.setItem("journalEntry", JSON.stringify(listData));
